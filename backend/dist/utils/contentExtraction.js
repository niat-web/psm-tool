...
exports.smartFetchContent = void 0;
...
const extractTextWithFallback = async (buffer, extension) => {
...
const extractGooglePublicPdf = async (url) => {
...
const extractSharepointContent = async (url) => {
...
const smartFetchContent = async (urlInput) => {
...
exports.smartFetchContent = smartFetchContent;
